          ...
          <div className="ak-row-padding">
            ...
            <img src={longdoug} alt="placeholder" style={{width:'100%'}}/>
                <div className="ak-container">
                  ...
                  <p><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/><br></br> View Code</button></p>
                  <p><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/><br></br> Deployed</button></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></p>
                  <p><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Android-Countdown-TImer" target="_blank" rel="noreferrer"><button href="https://github.com/Kovaceva11/Android-Countdown-TImer" className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Random-Password-Generator" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://kovaceva11.github.io/Random-Password-Generator" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Work-Day-Scheduler" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://kovaceva11.github.io/Work-Day-Scheduler/" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/CheapDate" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://kovaceva11.github.io/CheapDate/" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>
    {/* <!-- Update --> */}
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Employee-Tracker-CMS" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://github.com/Kovaceva11/Employee-Tracker-CMS" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>   
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Express.js-NOTE-TAKER" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://github.com/Kovaceva11/Express.js-NOTE-TAKER/blob/main/README.md" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>
            ...
            <div className="ak-third ak-margin-bottom">
              <div className="ak-card-4 ak-hover-opacity-off">
                ...
                <div className="ak-container">
                  ...
                  <p><a href="https://github.com/Kovaceva11/Team-Profile-Creator" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('code')}/></button></a></p>
                  <p><a href="https://github.com/Kovaceva11/Team-Profile-Creator/blob/main/README.md" target="_blank" rel="noreferrer"><button className="ak-button ak-light-grey ak-block"><FontAwesomeIcon icon={solid('rocket')}/></button></a></p>
                </div>
              </div>
            </div>
    {/* <!-- End Update --> */}
